...
filterDte <- '2025-01-31' #last day of report period
fy_start <- '2025-01-01'
curr_mo_start <- '2025-01-01'
...
psycModel::html_to_pdf(file_path = 
                         sprintf('C:\\Users\\dsole\\OneDrive\\Documents\\FinancialPlanning\\PVHC financials\\2025\\PVHC Monthly Report for %s.html' , reptDte) , 
                       scale = .88)
